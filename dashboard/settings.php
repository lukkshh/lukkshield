...
<body class="bg-black font-roboto">
    ...
    <div class="flex items-center justify-center w-full">
        <section class="text-white w-1/2 max-sm:w-[95%] max-2xl:w-[80%] bg-[#222222] p-6 rounded-lg">
            <div>
                <p class="text-xl font-semibold">Settings</p>
            </div>
            <div class="flex m-6 max-sm:m-0 space-x-12 max-sm:flex-col max-lg:flex-col max-lg:space-x-0 max-sm:space-x-0">
                <div class="flex">
                    <form
                action=""
                method="POST"
                ...
                >
                <div class="w-[380px] max-sm:w-full">
                    <p>Change Password</p>
                </div>
                <div class="relative">
                    <input
                    autocomplete="off"
                    class="peer p-4 placeholder-transparent outline-none text-white w-[390px] h-[55px] border-[#ffffff] border rounded-xl bg-transparent max-sm:max-w-[300px]"
                    id="password"
                    name="password"
                    type="password"
                    placeholder=" "
                ...
                <div>
                    <form action="" method="POST">
                        <p class="mt-2 max-sm:w-full">Account Deletion</p>
